...
// src/functions/complaints/create.ts
var create_exports = {};
...
// node_modules/drizzle-orm/gel-core/foreign-keys.js
...
// node_modules/drizzle-orm/gel-core/unique-constraint.js
...
var GelColumnBuilder = class extends ColumnBuilder {
  ...
  array(size2) {
    return new GelArrayBuilder(this.config.name, this, size2);
  }
  references(ref, actions = {}) {
    this.foreignKeyConfigs.push({ ref, actions });
    return this;
...
// node_modules/drizzle-orm/gel-core/indexes.js
...
var corroborations = pgTable("corroborations", {
...
var handler = async (event) => {
  try {
    if (!event.body) {
      return { statusCode: 400, body: JSON.stringify({ error: "Corpo da requisi\xE7\xE3o vazio." }) };
    }
    const data = JSON.parse(event.body);
    const { entityId, title, content, mediaUrl } = data;
    if (!entityId || !title || !content) {
      return { statusCode: 400, body: JSON.stringify({ error: "entityId, title e content s\xE3o obrigat\xF3rios." }) };
    }
    ...
    console.error("Erro ao criar reclama\xE7\xE3o:", error);
    return {
      statusCode: 500,
